...
namespace TraceLink.AspNetCore.Handler
{
    ...
    {
        private readonly IOutboundTracingIdProvider<TTracingContext> _idProvider;
        private readonly ITracingOptions<TTracingContext> _options;

        public OutboundTracingIdHandler(IOutboundTracingIdProvider<TTracingContext> idProvider, ITracingOptions<TTracingContext> options)
        {
